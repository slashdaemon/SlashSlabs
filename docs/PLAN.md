...
| R5 | Four-slot ceiling | Survey-driven allocation; vanilla slabs and snow layers cover the rest. Document the ceiling for other servers (conflicts with other Polymer slab mods). |
...
- Nether/End smoothing (netherrack, end stone) — needs slots or vanilla-slab stand-ins.
